...
public class BlueTrianglePGP extends OpMode {
    ...
    private final Pose prepPose = new Pose( 50, 60, Math.toRadians(90));

    private final Pose ballPose = new Pose( 20, 60, Math.toRadians(0));

    private final Pose ballControlPose = new Pose( 70, 50, Math.toRadians(0));
