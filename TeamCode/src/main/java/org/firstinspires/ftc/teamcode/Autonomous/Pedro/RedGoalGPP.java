...
public class RedGoalGPP extends OpMode {
    ...
    private final Pose shootPose2 = new Pose( 72, 35, Math.toRadians(0));

    private final Pose shootPose3 = new Pose( 133, 35, Math.toRadians(0));

    private final Pose shootPose4 = new Pose( 72, 9, Math.toRadians(65));
