...
public class HolonomicDrive {
    ...
    public static MotorPowers robotOrientedDrive(double x, double y, double turn, double maxMotorPower, OpMode opmode){
        return fieldOrientedDrive(x, y, turn, maxMotorPower, 0, opmode);
    }
}
