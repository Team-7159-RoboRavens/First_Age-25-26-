...
@Autonomous (name="BlueTrianglePPG")
public class BlueTrianglePPG extends OpMode {
    ...
    private final Pose prepPose = new Pose( 50, 84, Math.toRadians(90));

    private final Pose ballPose = new Pose( 20, 84, Math.toRadians(0));

    private final Pose ballControlPose = new Pose( 80, 60, Math.toRadians(0));

    private final Pose shootPose = new Pose( 60, 13, Math.toRadians(-60));
